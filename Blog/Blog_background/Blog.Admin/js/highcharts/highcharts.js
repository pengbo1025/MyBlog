...
(function (Aa, Y) { typeof module === "object" && module.exports ? module.exports = Aa.document ? Y(Aa) : function (B) { return Y(B) } : Aa.Highcharts = Y() })(typeof window !== "undefined" ? window : this, function (Aa) {
    ...
    b, c) {
    ...
    }; u.loadAdapter(K.HighchartsAdapter || K.jQuery); L = {
        ...
        }, global: { useUTC: !0, canvasToolsURL: "http://code.highcharts.com/modules/canvas-tools.js", VMLRadialGradientURL: "http://code.highcharts.com/4.1.10/gfx/vml-radial-gradient.png" }, chart: {
        ...
        }, credits: { enabled: !0, text: versionInfo, href: "http://www.highcharts.com", position: { align: "right", x: -10, verticalAlign: "bottom", y: -5 }, style: { cursor: "pointer", color: "#909090", fontSize: "9px" } }
    }; var ba = L.plotOptions, fa = ba.line; Db(); ea.prototype = {
        parsers: [{
        ...
        opacity: 1, textProps: "direction,fontSize,fontWeight,fontFamily,fontStyle,color,lineHeight,width,textDecoration,textOverflow,textShadow".split(","), init: function (a, b) { this.element = b === "span" ? $(b) : C.createElementNS(Ea, b); this.renderer = a }, animate: function (a, b, c) { b = p(b, this.renderer.globalAnimation, !0); Wa(this); if (b) { b = B(b, {}); if (c) b.complete = c; gb(this, a, b) } else this.attr(a, null, c); return this }, colorGradient: function (a, b, c) {
            ...
            if (nb || f) e.textRendering = "geometricPrecision"; g ? this.css(e) : (this.fakeTS = !0, this.ySetter = this.xSetter, c = [].slice.call(b.getElementsByTagName("tspan")), o(a.split(/\s?,\s?/g), function (a) {
                var d = b.firstChild, e, f, a = a.split(" "); e = a[a.length - 1]; (f = a[a.length - 2]) && o(c, function (a, c) {
                    var g; c === 0 && (a.setAttribute("x", b.getAttribute("x")), c = b.getAttribute("y"), a.setAttribute("y", c || 0), c === null && b.setAttribute("y", 0)); g = a.cloneNode(1); O(g, {
    ...
    b, c) { this[b] = a; if (this.stroke && this["stroke-width"]) this.strokeWidth = this["stroke-width"], M.prototype.fillSetter.call(this, this.stroke, "stroke", c), c.setAttribute("stroke-width", this["stroke-width"]), this.hasStroke = !0; else if (b === "stroke-width" && a === 0 && this.hasStroke) c.removeAttribute("stroke"), this.hasStroke = !1 }; var za = function () { this.init.apply(this, arguments) }; za.prototype = {
        Element: M, init: function (a, b, c, d, e, f) {
            ...
            var k = this.label(a, b, c, i, null, null, null, null, "button"), j = 0, l, m, n, s, r, p, a = { x1: 0, y1: 0, x2: 0, y2: 1 }, e = B({ "stroke-width": 1, stroke: "#CCCCCC", fill: { linearGradient: a, stops: [[0, "#FEFEFE"], [1, "#F6F6F6"]] }, r: 2, padding: 5, style: { color: "black" } }, e); n = e.style; delete e.style; f = B(e, {
                stroke: "#68A", fill: {
                    linearGradient: a,
                    stops: [[0, "#FFF"], [1, "#ACF"]]
                }
        ...
        b) { var c, d, a = a || this.style.fontSize; !a && b && K.getComputedStyle && (b = b.element || b, a = (c = K.getComputedStyle(b, "")) && c.fontSize); a = /px/.test(a) ? A(a) : /em/.test(a) ? parseFloat(a) * 12 : 12; c = a < 24 ? a + 3 : y(a * 1.2); d = y(c * 0.8); return { h: c, b: d, f: a } }, rotCorr: function (a, b, c) { var d = a; b && c && (d = v(d * T(b * ha), 4)); return { x: -a / 3 * aa(b * ha), y: d } }, label: function (a, b, c, d, e, f, g, h, i) {
            var k = this, j = k.g(i), l = k.text("", 0, 0, g).attr({ zIndex: 1 }), m, n, s = 0, r = 3, p = 0, z, w, D, v, ca = 0, hb = {}, u, E, I, C, A; I = function () {
                ...
                var a = j.styles, a = a && a.textAlign, b = p + r, c; c = h ? 0 : u; if (q(z) && n && (a === "center" || a === "right")) b += {
                    center: 0.5,
                    right: 1
            ...
            j.textSetter = function (a) { a !== x && l.textSetter(a); I(); C() }; j["stroke-widthSetter"] = function (a, b) { a && (E = !0); ca = a % 2 / 2; A(b, a) }; j.strokeSetter = j.fillSetter = j.rSetter = function (a, b) { b === "fill" && a && (E = !0); A(b, a) }; j.anchorXSetter = function (a, b) { e = a; A(b, y(a) - ca - D) }; j.anchorYSetter = function (a, b) { f = a; A(b, a - v) }; j.xSetter = function (a) { j.x = a; s && (a -= s * ((z || n.width) + 2 * r)); D = y(a); j.attr("translateX", D) }; j.ySetter = function (a) { v = j.y = y(a); j.attr("translateY", v) }; var F = j.css; return t(j, {
                css: function (a) {
                    if (a) {
                        var b = {}, a = B(a);
        ...
        Q = {
            init: function (a, b) {
                ...
                var a = this.rotation, b = T(a * ha), c = aa(a * ha); J(this.element, {
        ...
        }; u.VMLElement = Q = ma(M, Q); Q.prototype.ySetter = Q.prototype.widthSetter = Q.prototype.heightSetter = Q.prototype.xSetter; var Na = {
            ...
            b, c, d) {
                ...
                var c = this, d = b.style, e = a.tagName === "IMG" && a.style; J(a, {
                    flip: "x",
    ...
    {}, Nb = function () { function a() { var a = b.length, d; for (d = 0; d < a; d++) b[d](); b = [] } var b = []; return { push: function (c, d) { b.length === 0 && u.getScript(d, a); b.push(c) } } }(), bb = Q; Va.prototype = {
        addLabel: function () {
    ...
    }; var ja = u.Axis = function () { this.init.apply(this, arguments) }; ja.prototype = {
        defaultOptions: {
        ...
        }, defaultYAxisOptions: { endOnTick: !0, gridLineWidth: 1, tickPixelInterval: 72, showLastLabel: !0, labels: { x: -8, y: 3 }, lineWidth: 0, maxPadding: 0.05, minPadding: 0.05, startOnTick: !0, title: { rotation: 270, text: "Values" }, stackLabels: { enabled: !1, formatter: function () { return u.numberFormat(this.total, -1) }, style: B(ba.line.dataLabels.style, { color: "#000000" }) } }, defaultLeftAxisOptions: { labels: { x: -15, y: null }, title: { rotation: 270 } }, defaultRightAxisOptions: {
            labels: {
                x: 15,
                y: null
            }, title: { rotation: 90 }
    ...
    }; var Ob = u.Tooltip = function () { this.init.apply(this, arguments) }; Ob.prototype = {
        init: function (a, b) {
            var c = b.borderWidth, d = b.style, e = A(d.padding); this.chart = a; this.options = b; this.crosshairs = []; this.now = { x: 0, y: 0 }; this.isHidden = !0; this.label = a.renderer.label("", 0, 0, b.shape || "callout", null, null, b.useHTML, null, "tooltip").attr({
    ...
    }; var oa; cb = C.documentElement.ontouchstart !== x; var Xa = u.Pointer = function (a, b) { this.init(a, b) }; Xa.prototype = {
        init: function (a, b) {
        ...
        }, Cb = function (a, b, c, d) { a = a.originalEvent || a; if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && V[oa]) d(a), d = V[oa].pointer, d[b]({ type: c, target: a.currentTarget, preventDefault: ua, touches: Sb() }) }; t(Xa.prototype, {
            onContainerPointerDown: function (a) { Cb(a, "onContainerTouchStart", "touchstart", function (a) { va[a.pointerId] = { pageX: a.pageX, pageY: a.pageY, target: a.currentTarget } }) }, onContainerPointerMove: function (a) {
                Cb(a,
    ...
    "positionItem", function (a, b) { var c = this, d = function () { b._legendItemPos && a.call(c, b) }; d(); setTimeout(d) }); Q = u.Chart = function () { this.init.apply(this, arguments) }; Q.prototype = {
        ...
        isCartesian: !0, type: "line", pointClass: Ga, sorted: !0, requireSorting: !0, pointAttrToOptions: {
    ...
    Ib.prototype = {
        destroy: function () { Ra(this, this.axis) }, render: function (a) { var b = this.options, c = b.format, c = c ? Ja(c, this) : b.formatter.call(this); this.label ? this.label.attr({ text: c, visibility: "hidden" }) : this.label = this.axis.chart.renderer.text(c, null, null, b.useHTML).css(b.style).attr({ align: this.textAlign, rotation: b.rotation, visibility: "hidden" }).add(a) }, setOffset: function (a, b) {
    ...
    function () { var a = this, b = a.stackKey, c = a.yAxis.stacks, d = a.processedXData, e; o([b, "-" + b], function (b) { var f; for (var g = d.length, h, i; g--;) if (h = d[g], e = a.getStackIndicator(e, h, a.index), f = (i = c[b] && c[b][h]) && i.points[e.key], h = f) i = i.total ? 100 / i.total : 0, h[0] = ga(h[0] * i), h[1] = ga(h[1] * i), a.stackedYData[g] = h[1] }) }; R.prototype.getStackIndicator = function (a, b, c) { !q(a) || a.x !== b ? a = { x: b, index: 0 } : a.index++; a.key = [c, b, a.index].join(","); return a }; t(Q.prototype, {
        ...
        update: function (a, b) { var c = this.chart, a = c.options[this.coll][this.options.index] = B(this.userOptions, a); this.destroy(!0); this._addedPlotLB = this.chart._labelPanes = x; this.init(c, t(a, { events: x })); c.isDirtyBox = !0; p(b, !0) && c.redraw() }, remove: function (a) {
    ...
    }); var wa = ma(R); N.line = wa; ba.area = B(fa, { softThreshold: !1, threshold: 0 }); var pa = ma(R, {
    ...
    }); N.area = pa; ba.spline = B(fa); wa = ma(R, {
    ...
    }); N.spline = wa; ba.areaspline = B(ba.area); pa = pa.prototype; wa = ma(wa, {
        type: "areaspline",
    ...
    }); N.areaspline = wa; ba.column = B(fa, {
    ...
    }); N.column = wa; ba.bar = B(ba.column); pa = ma(wa, { type: "bar", inverted: !0 }); N.bar = pa; ba.scatter = B(fa, { lineWidth: 0, marker: { enabled: !0 }, tooltip: { headerFormat: '<span style="color:{point.color}">\u25cf</span> <span style="font-size: 10px;"> {series.name}</span><br/>', pointFormat: "x: <b>{point.x}</b><br/>y: <b>{point.y}</b><br/>" } }); pa = ma(R, {
        ...
        type: "pie",
        isCartesian: !1, pointClass: ma(Ga, {
            init: function () { Ga.prototype.init.apply(this, arguments); var a = this, b; a.name = p(a.name, "Slice"); b = function (b) { a.slice(b.type === "select") }; H(a, "select", b); H(a, "unselect", b); return a }, setVisible: function (a, b) {
        ...
        var f = this.chart, g = f.inverted, h = p(a.plotX, -9999), i = p(a.plotY, -9999), k = b.getBBox(), j = f.renderer.fontMetrics(c.style.fontSize).b, l = this.visible && (a.series.forceDL || f.isInsidePlot(h, y(i), g) || d && f.isInsidePlot(h, g ? d.x + 1 : d.y + d.height - 1, g)); if (l) d = t({ x: g ? f.plotWidth - i : h, y: y(g ? f.plotHeight - h : i), width: 0, height: 0 }, d), t(c, { width: k.width, height: k.height }), c.rotation ? (a = f.renderer.rotCorr(j, c.rotation), b[e ? "attr" : "animate"]({
            x: d.x +
    ...
    fa.drawTrackerPoint; if (N.scatter) pa.prototype.drawTracker = fa.drawTrackerPoint; t(pb.prototype, {
    ...
    }); L.legend.itemStyle.cursor = "pointer"; t(Q.prototype, {
