<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CaegoryList.aspx.cs" Inherits="Blog.View.Caegory" %>
...
<body class="fixed-top">
                    ...
                    <div class="span12">
                        <div class="widget red">
                            ...
                            <div class="widget-body">
                                ...
                                <div class="row-fluid">
                                    ...
                                    <div class="span3">
                                             <div class="control-group">
                                                <div class="controls controls-row">分类ID<br />
                                ...
                                <button class="btn  btn-primary" onclick="Add();" >添加Caegory</button>
                            </div>
                        </div>
                    </div>
                </div>
   ...
   <script src="/js/common-scripts.js"></script>
    ...
    <script src="/script/Caegory.js?v=<%=new Random().Next() %>"></script>
</html>
