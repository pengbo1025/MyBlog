<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsList.aspx.cs" Inherits="Blog.View.News" %>
...
<body class="fixed-top">
                    ...
                    <div class="span12">
                        <div class="widget red">
                            ...
                            <div class="widget-body">
                                ...
                                <div class="row-fluid">
                                    ...
                                    <div class="span3">
                                             <div class="control-group">
                                                <div class="controls controls-row">新闻ID<br />
                                ...
                                <button class="btn  btn-primary" onclick="Add();" >添加News</button>
                            </div>
                        </div>
                    </div>
                </div>
   ...
   <script src="/js/common-scripts.js"></script>
    ...
    <script src="/script/News.js?v=<%=new Random().Next() %>"></script>
</html>
